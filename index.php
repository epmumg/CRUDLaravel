...
<html lang="en">
  <head>
    <title>Empleados DesWeb Laravel</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
          ...
          <form class="d-flex" action="crud_empleado.php" method="post">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="txt_nombres" id="txt_nombres" class="form-control" placeholder="Nombres: Dhixon jhordyn" required>
              </div>
              <div class="mb-3">
                <label for="lbl_apellidos" class="form-label"><b>Apellidos</b></label>
                <input type="text" name="txt_apellidos" id="txt_apellidos" class="form-control" placeholder="Apellidos: Nuñez Nuñez" required>
              </div>
              <div class="mb-3">
